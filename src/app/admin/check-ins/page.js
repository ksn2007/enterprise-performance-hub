...
export default function AdminCheckinsPage() {
  const checkins = [
    { name: 'Sarah Jenkins', role: 'Frontend Engineer', goal: 'Automate Q4 Invoice Billing System', actual: '30%', target: '40%', status: 'On Track', date: '2024-05-18', manager: 'Sarah Manager' },
    { name: 'Alex Employee', role: 'Full Stack Engineer', goal: 'Expand Regional Infrastructure', actual: '2 nodes', target: '5 nodes', status: 'On Track', date: '2024-05-15', manager: 'Sarah Manager' },
    { name: 'Sarah Jenkins', role: 'Frontend Engineer', goal: 'Design API Gateway for External Vendors', actual: '0', target: '1', status: 'Under Review', date: '2024-05-14', manager: 'Sarah Manager' }
  ];
      ...
      <DashboardLayout role="admin">
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="border-b border-outline-variant pb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="font-headline-lg text-headline-lg font-bold text-primary">System-Wide Check-in Audits</h1>
              <p className="text-body-md text-on-surface-variant">Review the global log of actual check-in data events reported by all business roles across corporate systems.</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <h2 className="font-headline-sm text-headline-sm font-bold text-on-surface flex items-center gap-2">
              <span className="material-symbols-outlined text-primary">history</span> Global Check-in Timeline Feed
            </h2>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                    <div className="space-y-1">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-body-sm text-on-surface-variant">({check.role})</span>
                        <span className="w-1.5 h-1.5 rounded-full bg-outline-variant"></span>
                        <span className="text-body-sm text-on-surface-variant">Line Manager: {check.manager}</span>
                        <span className="w-1.5 h-1.5 rounded-full bg-outline-variant"></span>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="bg-surface-container-low px-4 py-2 rounded-lg border border-outline-variant text-center">
                        <span className="text-label-sm text-on-surface-variant">Reported progress</span>
